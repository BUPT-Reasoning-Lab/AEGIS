...
- Such as experimental apparatus, biological samples, or humans, these entities are considered foreground objects.
- Any region that does not convey explicit semantic or academic information should be regarded as background (e.g., mounting platforms, slides, or environmental surfaces).
