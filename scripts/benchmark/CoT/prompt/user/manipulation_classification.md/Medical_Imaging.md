...
- In medical images (e.g., radiological images acquired via X-ray or other imaging modalities, endoscopy, retinal, etc. ), legends, text, arrows, and overlaid markers are considered foreground objects, while the imaging plate or scan itself serves as the background.
