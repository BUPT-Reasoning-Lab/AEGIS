...
- All textual elements (e.g., axis labels, annotations, legends) are semantically meaningful and free from garbled, misspelled, or pseudo-text characters; for example, numerical values on the x- and y-axes follow valid mathematical patterns (such as arithmetic sequences), and identifiers for the same type of chemical substances follow consistent and meaningful numbering schemes.
