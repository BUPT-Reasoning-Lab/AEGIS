...
- Structural boundaries (e.g., tissue-level structures, cellular boundaries, or material/particle interfaces) appear irregular yet physically plausible, lacking artificially smooth contours or overly stylized outlines.
...
Output format:
Please output your answer in non-segmented text format, not Markdown format, as follows: "[Localization of the AI-generated region] (Partially AI-Edited only) [Explanation of the AI-generated clues found in the image, such as inconsistent textures, textual hallucination, etc.]"  
